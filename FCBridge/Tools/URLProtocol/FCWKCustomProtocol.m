...
@interface FCWKCustomProtocol()
@property(nonatomic, strong) NSURLSessionDataTask *dataTask;
@end

@implementation FCWKCustomProtocol
...
- (NSString *)_getWebViewReuseLoadString{
    return @"<html><head><meta name=\"viewport\" " @"content=\"initial-scale=1.0,width=device-width,user-scalable=no\"/><title>FCWebKit-Reuse</title></head><body></body></html>";
}
